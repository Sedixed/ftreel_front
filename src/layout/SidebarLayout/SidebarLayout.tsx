...
import { Box, Divider, List, ListItem, ListItemButton, ListItemIcon, ListItemText, hexToRgb, useTheme } from '@mui/material';
...
export default function SidebarLayout() {
  ...
  const buildSidebarElement = (element: SidebarElement) => {
    return (
      <Link to={element.href} style={{ textDecoration: "none", color: "inherit" }}>
